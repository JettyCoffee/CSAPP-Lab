...
00000000004017c0 <touch1>:
  ...
  4017d3:	e8 e8 f4 ff ff       	call   400cc0 <puts@plt>   # 0xa0 - 0x78 = 0x28
...
000000000040184c <hexmatch>:
  ...
  40184e:	55                   	push   %rbp
  40184f:	53                   	push   %rbx #占用3*8 = 24 字节
  ...
  4018ab:	48 c7 c2 ff ff ff ff 	mov    $0xffffffffffffffff,%rdx  #rdx给到字节数量为128
...
00000000004018fa <touch3>:
  4018fa:	53                   	push   %rbx  #占用stack的8 字节
  4018fb:	48 89 fb             	mov    %rdi,%rbx
  4018fe:	c7 05 d4 2b 20 00 03 	movl   $0x3,0x202bd4(%rip)        # 6044dc <vlevel>
  401905:	00 00 00 
  401908:	48 89 fe             	mov    %rdi,%rsi
  40190b:	8b 3d d3 2b 20 00    	mov    0x202bd3(%rip),%edi        # 6044e4 <cookie>
  401911:	e8 36 ff ff ff       	call   40184c <hexmatch>  #将%rip的值传递给call指令，然后跳转到40184c
